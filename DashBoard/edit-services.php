...
?> 
							 ...
							 <input type="text" class="form-control" id="sername" name="sername" placeholder="Service Name" value="<?php  echo $row['ServiceName'];?>" required="true"> </div> <div class="form-group">
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Service Id</label>
							  <input type="text" class="form-control" id="editid" name="editid" placeholder="Service Id" value="<?php  echo $row['ID'];?>" required="true"> 
							</div> 
							 <?php } ?>
							  <button type="delete" name="delete" class="btn btn-default">Delete</button> </form> 
						</div>
